...
namespace DA_1BanTuiSach
{
    public partial class DangNhap: Form
    {
		...
		{
			SqlConnection conn = new SqlConnection(@"Data Source=TINHLV\SQLEXPRESS;Initial Catalog=QL02;Integrated Security=True;Encrypt=True;TrustServerCertificate=True");
			try
			{
				conn.Open();
